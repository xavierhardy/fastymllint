...
impl YamllintRuleConfig {
    pub fn is_enabled(&self) -> bool {
        match self {
            ...
            YamllintRuleConfig::Detailed(map) => {
                !map.get("disable")
...
impl YamllintConfig {
    ...
    pub fn default_config() -> Self {
        ...
        rules.insert("comments-indentation".to_string(), YamllintRuleConfig::Enabled(true));
        rules.insert("document-end".to_string(), YamllintRuleConfig::Enabled(false));
        rules.insert("document-start".to_string(), YamllintRuleConfig::Enabled(false));
        rules.insert("empty-lines".to_string(), YamllintRuleConfig::Enabled(true));
        rules.insert("empty-values".to_string(), YamllintRuleConfig::Enabled(false));
        ...
        rules.insert("key-duplicates".to_string(), YamllintRuleConfig::Enabled(true));
        rules.insert("key-ordering".to_string(), YamllintRuleConfig::Enabled(false));
        rules.insert("line-length".to_string(), YamllintRuleConfig::Enabled(true));
        rules.insert("new-line-at-end-of-file".to_string(), YamllintRuleConfig::Enabled(true));
        rules.insert("new-lines".to_string(), YamllintRuleConfig::Enabled(true));
        rules.insert("trailing-spaces".to_string(), YamllintRuleConfig::Enabled(true));
    ...
    pub fn relaxed_config() -> Self {
        ...
        config.rules.insert("braces".to_string(), YamllintRuleConfig::Detailed({
            let mut m = HashMap::new();
            m.insert("min-spaces-inside".to_string(), serde_yaml_ng::Value::Number(0.into()));
            m.insert("max-spaces-inside".to_string(), serde_yaml_ng::Value::Number(1.into()));
            m
        }));
        config.rules.insert("brackets".to_string(), YamllintRuleConfig::Detailed({
            let mut m = HashMap::new();
            m.insert("min-spaces-inside".to_string(), serde_yaml_ng::Value::Number(0.into()));
            m.insert("max-spaces-inside".to_string(), serde_yaml_ng::Value::Number(1.into()));
            m
        }));
        config.rules.insert("colons".to_string(), YamllintRuleConfig::Detailed({
            let mut m = HashMap::new();
            m.insert("max-spaces-after".to_string(), serde_yaml_ng::Value::Number((-1).into()));
            m
        }));
        config.rules.insert("commas".to_string(), YamllintRuleConfig::Detailed({
            let mut m = HashMap::new();
            m.insert("max-spaces-after".to_string(), serde_yaml_ng::Value::Number((-1).into()));
            m
        }));
        config.rules.insert("comments".to_string(), YamllintRuleConfig::Enabled(false));
        config.rules.insert("comments-indentation".to_string(), YamllintRuleConfig::Enabled(false));
        config.rules.insert("empty-lines".to_string(), YamllintRuleConfig::Detailed({
            let mut m = HashMap::new();
            m.insert("max".to_string(), serde_yaml_ng::Value::Number(3.into()));
            m
        }));
        config.rules.insert("hyphens".to_string(), YamllintRuleConfig::Enabled(false));
        config.rules.insert("indentation".to_string(), YamllintRuleConfig::Enabled(false));
        config.rules.insert("line-length".to_string(), YamllintRuleConfig::Detailed({
            let mut m = HashMap::new();
            m.insert("max".to_string(), serde_yaml_ng::Value::Number(120.into()));
            m.insert("allow-non-breakable-inline-mappings".to_string(), serde_yaml_ng::Value::Bool(true));
            m
        }));
        config.rules.insert("truthy".to_string(), YamllintRuleConfig::Enabled(false));
